...
public class TxtTimeSlotRepository implements TimeSlotRepository {

    private final String filePath;
    private static final String DEFAULT_FILE_PATH = "data/timeslots.txt";
    ...
    public TxtTimeSlotRepository(String filePath) {
    ...
    private void ensureFileExists() {
        try {
            ...
            throw new RuntimeException("Cannot initialise timeslots file: " + filePath, e);
        }
    }
