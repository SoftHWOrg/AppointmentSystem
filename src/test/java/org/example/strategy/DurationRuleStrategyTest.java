...
class DurationRuleStrategyTest {
    ...
    void testIsValid_urgentWithin30min_returnsTrue() {
        ...
        Appointment appt = new UrgentAppointment(1, testUser, slot, AppointmentStatus.CONFIRMED, 1);
    ...
    void testIsValid_groupWithin120min_returnsTrue() {
        ...
        Appointment appt = new GroupAppointment(1, testUser, slot, AppointmentStatus.CONFIRMED, 10);
        assertTrue(strategy.isValid(appt));
    }
}
